...
def parse_agent_config(workflow_data: Dict[str, Any]) -> Dict[str, Any]:
    config = {
        "has_mcp": False,
    ...
    node_type = workflow_data.get("type")
    node_config = workflow_data.get("config", {})
    attachments = workflow_data.get("attachments", {})
